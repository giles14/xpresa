            ...
            <div class="row">
                <div class="col-md-7 col-sm-6">
                    ...
                    <div class="redes-sociales">
                        ...
                        <div class="img-social"><a target="_blank" href="https://www.youtube.com/watch?v=zUdlcqejlcs&ab_channel=IEXETV"><img src="assets/img/IconYT-XpresaPurple.png" alt=""></a></div>
                  ...
                  <div class="formulario">
                      ...
                      <div class="cuerpo">
                          <form id="interes" method="POST" action="">
                              ...
                              <input id="hiddenPrograma" name="programa" type="hidden" value="SINA">
                                  <button type="button" onclick="enviarFormulario(this)" class="btn btn-primario mt-3 boton-registro">ENVIAR REGISTRO</button>
                              </div>
                            </form>
                      </div>
